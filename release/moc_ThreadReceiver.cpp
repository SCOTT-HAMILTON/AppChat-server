/****************************************************************************
** Meta object code from reading C++ file 'ThreadReceiver.h'
**
...
#include "../../AppChat-client/ThreadReceiver.h"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'ThreadReceiver.h' doesn't include <QObject>."
...
QT_MOC_LITERAL(2, 28, 0) // ""
    ...
    "ThreadReceiver\0datareceived\0"
};
...
void ThreadReceiver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ThreadReceiver::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ThreadReceiver::datareceived)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ThreadReceiver::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_ThreadReceiver.data,
      qt_meta_data_ThreadReceiver,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ThreadReceiver::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ThreadReceiver.stringdata0))
        return static_cast<void*>(const_cast< ThreadReceiver*>(this));
...
// SIGNAL 0
void ThreadReceiver::datareceived()
{
